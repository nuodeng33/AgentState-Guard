...
class EventType(str, Enum):
    ...
    # Sandbox observer facts (additive; readers filtering by value are
    # unaffected). File activity reuses OBSERVED_CHANGE under CHANGE.
    SANDBOX_PROCESS_STARTED = "SANDBOX_PROCESS_STARTED"
    SANDBOX_PROCESS_EXITED = "SANDBOX_PROCESS_EXITED"
    SANDBOX_NETWORK_OBSERVED = "SANDBOX_NETWORK_OBSERVED"
    SANDBOX_OBSERVER_LIFECYCLE = "SANDBOX_OBSERVER_LIFECYCLE"
    PROCESS_STARTED = "PROCESS_STARTED"
    PROCESS_EXITED = "PROCESS_EXITED"
    WORKSPACE_ACTIVITY_OBSERVED = "WORKSPACE_ACTIVITY_OBSERVED"
    HOST_OBSERVER_LIFECYCLE = "HOST_OBSERVER_LIFECYCLE"
