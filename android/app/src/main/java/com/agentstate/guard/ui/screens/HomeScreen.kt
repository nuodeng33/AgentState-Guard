...
/**
 * Home. Unpaired: brand + three connection entries. Paired: the desktop
...
@Composable
private fun UnpairedHome(onScanQr: () -> Unit, onFindLan: () -> Unit, onManualAddress: () -> Unit) {
    Text(
    ...
    OutlinedButton(onClick = onFindLan, modifier = Modifier.fillMaxWidth()) {
        Text(stringResource(R.string.action_find_lan))
    }
    OutlinedButton(onClick = onManualAddress, modifier = Modifier.fillMaxWidth()) {
