...
> **SUPERSEDED IN PART BY docs/product/V1_SCOPE_FREEZE_2026-08-11.md.**
> The v1 scope, LAN bind and transport, Android surface, endpoint contract,
> acceptance order, and deferred list in that freeze govern where they conflict
> with this historical design. This document does not authorize new R4/P7/P8/P9
> semantics, implementation work, or release claims.
